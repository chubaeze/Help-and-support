                  ...
                  <div tw="[>div]:(cursor-pointer m-2 h-auto p-4 border-black rounded-xl w-11/12 hover:shadow) bg-white flex flex-col justify-between rounded-xl lg:([>div]:(cursor-pointer m-2 h-auto p-2 rounded-xl w-80 hover:shadow) bg-white flex flex-col justify-between rounded-xl w-8/12)">
                    <Link href="/">
                      <div>
                        ...
                        <p tw="text-xs text-gray-400">15 Articles</p>
                      </div>
                    </Link>
                    <Link href="/">
                      <div>
                    ...
                    <Link href="/">
                      <div>
                        ...
                        <p tw="text-xs text-gray-400">4 Articles</p>
                      </div>
                    </Link>
                    <Link href="/">
                      <div>
                        <h3 tw="text-base">"I got charged twice!"</h3>
                        <p tw="text-xs text-gray-400">5 Articles</p>
                      </div>
                    </Link>
                    <Link href="/">
                      <div>
                        ...
                        <p tw="text-xs text-gray-400">3 Articles</p>
                      </div>
                    </Link>
                    <Link href="/">
                      <div tw="mb-2">
                        <h3 tw="text-base">Why aren't there recurring gigs?</h3>
                        <p tw="text-xs text-gray-400">28 Articles</p>
                      </div>
                    </Link>
                  </div>
                </div>
...
export default SubCatPath_Vendor
