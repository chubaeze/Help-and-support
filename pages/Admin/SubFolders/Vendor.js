...
const Vendor = () => {
  return (
    <Fragment>
      <div tw="flex bg-neutral1 h-[920px]">
        <SideBar></SideBar>
        <div tw="w-screen">
          <HeadBar></HeadBar>
          <div tw=" h-[750px] w-[100%] flex flex-col">
            ...
            <div tw="p-2 border bg-white h-[800px] rounded-lg mx-2">
              ...
              <div tw="w-[1000px]">
                <div tw="pl-10 pr-10 flex space-x-1 lg:(pl-20 mt-2 pb-4 w-auto flex flex-row space-x-20)">
                  ...
                  <br></br>
                  <div tw="lg:(flex border mx-auto h-[650px] pr-20 pt-1 pl-10 rounded-2xl)">
                    <form>
                      ...
                      <div tw="flex justify-between">
                        <div tw="text-white bg-purple-600 flex justify-center items-center border rounded-2xl text-xs p-2 pr-4 pl-4 lg:(text-sm pr-8 pl-8)">
