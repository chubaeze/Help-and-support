  ...
  return (
    <Fragment>
      ...
      <div tw="max-w-screen-2xl mx-auto pb-40 bg-neutral">
        ...
        <div tw="flex flex-row pl-44 pr-44 pb-28 mt-2 w-auto space-x-32">
          ...
          <br></br>
          <div tw="[>div]:(m-2 h-auto p-4 border-black rounded-xl w-max hover:shadow) bg-white flex flex-col justify-between rounded-xl w-5/12">
            <div>
